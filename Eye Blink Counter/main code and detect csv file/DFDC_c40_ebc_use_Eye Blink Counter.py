...
folder_path = 'E:\\Research\\dataset\\FaceForensics++\\manipulated_sequences\\DeepFakeDetection\\c40\\videos'
format = '.mp4'

# 調用function獲取滿足條件的filename
filenames = get_filenames(folder_path, format)

csv_file_path = 'DeepFakeDetection_c40_Eyes_Blink_Counter.csv'
