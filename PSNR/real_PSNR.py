...
def main():
    ...
    # 将PSNR数据写入CSV文件
    csv_file_path = os.path.join(output_directory, "original_sequences_psnr_data.csv")
...
def calculate_original_ELA():
    png_input_directory = f'/home/kent/Baseline_method/CADDM/train_images/original_sequences/Deepfakes/raw/frames'
    jpg_input_directory=f'/home/kent/dataset/ELA_data/original_sequences/Deepfakes/'
    output_directory = f'/home/kent/dataset/PSNR/'
    # 搜索第二子資料夾中的所有image.png文件
...
def calculate_realELA_fakeELA():
    ...
    fake_input_directory=f'/home/kent/dataset/ELA_data/original_sequences/Deepfakes/'
    output_directory = f'/home/kent/dataset/PSNR/'
    # 搜索第二子資料夾中的所有image.png文件
