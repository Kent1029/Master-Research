...
def crop_ela_mask(args):
    ...
    real_input_directories = f'/home/kent/Baseline_method/CADDM/train_images/Celeb-DF/Celeb-real/'
    fake_input_directories = f'/home/kent/Baseline_method/CADDM/train_images/Celeb-DF/Celeb-synthesis/'
    real_output_directory = f'/home/kent/dataset/ELA_data/Celeb_DF/Celeb-real/train/'
    os.makedirs(real_output_directory, exist_ok=True)
    fake_output_directory = f'/home/kent/dataset/ELA_data/Celeb_DF/Celeb-synthesis/train/'
...
def test_crop_ela_mask():
    ...
    real_input_directories = f'/home/kent/Baseline_method/CADDM/test_images/Celeb-DF/Celeb-real/'
    fake_input_directories = f'/home/kent/Baseline_method/CADDM/test_images/Celeb-DF/Celeb-synthesis/'
    real_output_directory = f'/home/kent/dataset/ELA_data/Celeb_DF/Celeb-real/test/'
    os.makedirs(real_output_directory, exist_ok=True)
    fake_output_directory = f'/home/kent/dataset/ELA_data/Celeb_DF/Celeb-synthesis/test/'
    os.makedirs(fake_output_directory, exist_ok=True)
